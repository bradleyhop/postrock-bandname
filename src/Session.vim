...
nnoremap <SNR>286_: :=v:count ? v:count : ''
...
set pyxversion=2
set ruler
set runtimepath=~/.vim,~/.vim/plugged/syntastic,~/.vim/plugged/nerdtree,~/.vim/plugged/nerdcommenter,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-airline-themes,~/.vim/plugged/delimitmate,~/.vim/plugged/tagbar,~/.vim/plugged/vim-pasta,~/.vim/plugged/vim-trailing-whitespace,~/.vim/plugged/vim-surround,~/.vim/plugged/vim-repeat,~/.vim/plugged/vim-fugitive,~/.vim/plugged/vim-gitgutter,~/.vim/plugged/coc.nvim,~/.vim/plugged/coc-tsserver,~/.vim/plugged/coc-html,~/.vim/plugged/coc-css,~/.vim/plugged/coc-vetur,~/.vim/plugged/coc-json,~/.vim/plugged/coc-emmet,~/.vim/plugged/vim-indent-guides,~/.vim/plugged/tabular,~/.vim/plugged/vim-tmux-navigator,~/.vim/plugged/fzf.vim,~/.vim/plugged/ack.vim,~/.vim/plugged/vim-minimap,~/.vim/plugged/nyancat-vim,~/.vim/plugged/emmet-vim,~/.vim/plugged/vim-prettier,~/.vim/plugged/vim-easymotion,~/.vim/plugged/vim-polyglot,~/.vim/plugged/vimterial_dark,~/.vim/plugged/vim-css-color,~/.vim/plugged/MatchTagAlways,~/.vim/plugged/vim-lint,~/.vim/plugged/awesome-vim-colorschemes,~/.vim/plugged/vim-quantum,~/.vim/plugged/vim-wakatime,~/.vim/plugged/csv.vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/plugged/tabular/after,~/.vim/plugged/vim-polyglot/after,~/.vim/plugged/vim-css-color/after,~/.vim/plugged/awesome-vim-colorschemes/after,~/.vim/after
set scrolloff=4
set shiftwidth=2
...
silent only
silent tabonly
cd ~/git/postRockName/postrock-bandname/src
...
%argdel
$argadd App.vue
$argadd components/FormGenerator.vue
edit App.vue
...
silent! normal! zE
let s:l = 27 - ((17 * winheight(0) + 13) / 26)
...
wincmd w
argglobal
if bufexists("~/git/postRockName/postrock-bandname/public/index.html") | buffer ~/git/postRockName/postrock-bandname/public/index.html | else | edit ~/git/postRockName/postrock-bandname/public/index.html | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <C-G>g <Plug>delimitMateJumpMany
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
argglobal
2argu
if bufexists("postRock.js") | buffer postRock.js | else | edit postRock.js | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <C-G>g <Plug>delimitMateJumpMany
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 253 - ((16 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
253
...
tabnext 1
badd +1 App.vue
badd +0 components/FormGenerator.vue
badd +0 ~/git/postRockName/postrock-bandname/public/index.html
badd +0 postRock.js
